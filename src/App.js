...
function FrontPage() {
  return (
    <Container fluid className="p-4">
      ...
      {/* Upload and Status Tracking Section */}
      <section className="upload-section mb-5">
        <h2 className="text-center mb-4">Upload EDI Files and Track Status</h2>
        <Row>
          <Col md={6}>
            <Card className="mb-3">
              <Card.Body>
